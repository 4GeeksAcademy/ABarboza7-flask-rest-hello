...
Revision ID: ee12d45bea80
Revises: 60d84febe64d
Create Date: 2026-03-03 02:46:52.513027
...
revision = 'ee12d45bea80'
down_revision = '60d84febe64d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.UniqueConstraint('user_from_id', 'user_to_id', name='unique_follow')
    )
    ...
    with op.batch_alter_table('user1', schema=None) as batch_op:
        ...
        batch_op.drop_constraint('user1_first_name_key', type_='unique')
        batch_op.drop_constraint('user1_last_name_key', type_='unique')
        batch_op.drop_constraint('user1_user_name_key', type_='unique')
...
def downgrade():
    ...
    with op.batch_alter_table('user1', schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint('user1_user_name_key', ['user_name'])
        batch_op.create_unique_constraint('user1_last_name_key', ['last_name'])
        batch_op.create_unique_constraint('user1_first_name_key', ['first_name'])
